...
public class Gui {
    ...
    private void showFrame() {
        ...
        frame.setTitle("urban dicti");
        frame.setFont(font);
        JLabel label = new JLabel("let us urban dicti.....");
        label.setFont(font);
        frame.add(label);
        frame.pack();
    ...
    public static void insert() throws IOException, ParseException {
        ...
        String PATH = String.format("c:/c1/dic/");
        ...
        RandomAccessFile r = new RandomAccessFile(new File("c:/c1/dic/" + formatter.format(today) + ".txt"), "rw");
        RandomAccessFile rtemp = new RandomAccessFile(new File("c:/c1/dic/" + formatter.format(today) + ".txt" + "~"), "rw");
        ...
        r.writeBytes(System.getProperty("line.separator"));
        r.writeBytes("urban: "+textArea.getText());
        try {
            Desktop.getDesktop().browse(new URL("http://www.urbandictionary.com/define.php?term=" + textArea.getText().replace(" ", "%20")).toURI());
