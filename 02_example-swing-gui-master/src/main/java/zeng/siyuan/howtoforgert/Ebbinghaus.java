...
public class Ebbinghaus implements Serializable {
    ...
    public Ebbinghaus(String word) {
        this.date = new Date();
        final long ONE_MINUTE_IN_MILLIS = 60000;//millisecs

        long curTimeInMs = date.getTime();
        first = new Task(new Date(curTimeInMs + (20 * ONE_MINUTE_IN_MILLIS)), word);
        second = new Task(new Date(curTimeInMs + (60 * ONE_MINUTE_IN_MILLIS)), word);
        third = new Task(new Date(curTimeInMs + (540 * ONE_MINUTE_IN_MILLIS)), word);
        fourth = new Task(new Date(curTimeInMs + (24*60 * ONE_MINUTE_IN_MILLIS)), word);
        fifth = new Task(new Date(curTimeInMs + (2*24*60 * ONE_MINUTE_IN_MILLIS)), word);
        sixth = new Task(new Date(curTimeInMs + (6*24*60 * ONE_MINUTE_IN_MILLIS)), word);
        seventh = new Task(new Date(curTimeInMs + (31*24*60 * ONE_MINUTE_IN_MILLIS)), word);
        tasks.add(first);
        tasks.add(second);
        tasks.add(third);
        tasks.add(fourth);
